...
if strcmp(dataset, 'Flower-102_VGG') == 1
    nDimArray = [4096];
elseif strcmp(dataset, 'Flower-102_sift') == 1
    nDimArray = [5120];
end
nExperiment = 1;
% -------------------------------------------------------------------------
        ...
        for alpha = [0 0.001 0.005 0.01 0.05 .1 .5 1 5 10]
            ...
            for beta = [0 0.001 0.005 0.01 0.05 .1 .5 1 5 10]
                ...
                for maxIter = [5:5:100]
                    ...
                    if avgacc>=0.95
                        matname = sprintf([writefilepath dataset '_' num2str(nExperiment) '_' ClassificationMethod '_DR' num2str(Par.nDim) '_maxIter' num2str(Par.maxIter) '_rho' num2str(Par.rho) '_a' num2str(Par.alpha) '_b' num2str(Par.beta) '.mat']);
