...
% ClassificationMethod = 'ADANNLSR' ; % adaptive deformable, affine and non-negative LSR
% ClassificationMethod = 'ADANPLSR' ; % adaptive deformable, affine and non-positive LSR
% -------------------------------------------------------------------------
